...
public class Player1 : Life,I_hp
{
   ...
   /// </summary>
    ...
    private void WallSlide()
    {
        ...
        {
            ray = new Ray(this.transform.position - 
                new Vector3(0,_playerSprite.sprite.rect.height / _playerSprite.sprite.pixelsPerUnit,0)
                , Vector3.right);
        }
    ...
    private void WallSlideRaycast(Ray ray)
    {
        ...
        float Distance = (_playerSprite.sprite.rect.width * 0.47f)/ _playerSprite.sprite.pixelsPerUnit;
